    ...
    return(
        <div className=" bg-white flex-none order-1 flex-grow-0 lg:pl-[100px] xl:ml-[300px]">
            <div className="bg-[#2A254B] lg:w-[800px] lg:h-[400px]  sm:text-center lg:text-center md:w-[680px] md:h-[350px]"> 
                ...
                <Button variant="destructive" className="lg:self-end lg:mb-4 bg-[#494465] text-[#8e8a9f] mt-[50px] ml-[50px] xl:mt-[50px] xl:ml-[50px] xl:justify-start xl:flex md:justify-center">View Products</Button>
